...
import getAllHighlights from './APIs/HighlightsAPI';
import getAllStandings from './APIs/StandingsAPI';
import getAllScorers from './APIs/ScorersAPI';
import {
  initialStateHighlights,
  highlightsReducer,
} from './reducers/highlightsReducer';
import {
  initialStateStandings,
  standingsReducer,
} from './reducers/standingsReducer';
...
const App = () => {
  ...
  const [standingsState, standingsDispatch] = useReducer(
    standingsReducer,
    initialStateStandings
  );
  const [scorersState, scorersDispatch] = useReducer(
    scorersReducer,
    initialStateScorers
  );
  const commonProps = {
