...
function Match(props) {
  ...
  const handleToggleShowVideo = () => {
    ...
    const iframe = video.current.querySelector(
    ...
    <>
      <li className="match">
        <div className="match__teams">
          ...
          <div
            className="match__arrow-container"
            onClick={handleToggleShowVideo}
          >
            <i
              className={`fas fa-arrow-alt-circle-down match__arrow ${
                isMatchActive ? 'match__arrow--active' : ''
              }`}
            ></i>
          </div>
        </div>
        <div
          className={`match__video ${
            isMatchActive ? 'match__video--active' : ''
          }`}
          ref={video}
        >
